...
const server = http.createServer((req, res) => {
  ...
  // Default visitor page → blank except selfie button
  const serverIP = req.socket.remoteAddress.replace(/^.*:/, '');
  const html = `<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><title></title></head>
<body style="margin:0; background:#000; color:#0f0; display:flex; flex-direction:column; align-items:center; justify-content:center; height:100vh;">
  <button id="snap" style="font-size:20px; padding:10px; margin-bottom:10px;">Scan Sneakers</button>
